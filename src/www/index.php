...
<html>
<head>
	<!-- (c) & (p) think.dk 2009-2010 //-->
	<!-- All material protected by copyrightlaws //-->
	<meta name="google-site-verification" content="MbLL459QavncFr9ChNv5Gley9Upn1kxuKGOLLE1_IBA" />
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
	<title>kaestel.dk</title>
	<script language="javascript" type="text/javascript" src="js/scripts.js"></script>
	<style type="text/css">@import url(css/styles.css);</style>
	<script type="text/javascript">
		var _gaq = _gaq || [];
		_gaq.push(['_setAccount', 'UA-17394677-1']);
		_gaq.push(['_setDomainName', '.kaestel.dk']);
